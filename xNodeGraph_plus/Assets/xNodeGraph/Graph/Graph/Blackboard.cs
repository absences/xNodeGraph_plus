...
using static Game.Graph.BaseGraph;
    ...
    public class Blackboard {
        ...
        public class Unit {
            ...
            public object GetValue() {
                ...
                else if (this.type == typeof(Boolen).ToString()) {
                    return this.boolean;
                }
                ...
                else if (this.type == typeof(UEFun).ToString())
                {
                    return this.fun;
                }
                return this.obj;
    ...
    public class BlackboardDrawer : OdinValueDrawer<Blackboard> {
        ...
        protected override void DrawPropertyLayout(GUIContent label) {
            ...
            for (int i = 0; i < self.values.Length; i++) {
                ...
                else if (unit.type == typeof(Boolen).ToString()) {
                ...
                else if (unit.type == typeof(Obj).ToString())
                {
